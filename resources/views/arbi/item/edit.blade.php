                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('form/confirm') }}">
                        ...
                        <div class="form-group{{ $errors->has('attribute1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="attribute1" type="text" class="form-control" name="attribute1" value="{{ old('attribute1') }}">
                        ...
                        <div class="form-group{{ $errors->has('attribute2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="attribute2" type="text" class="form-control" name="attribute2" value="{{ old('attribute2') }}">
                        ...
                        <div class="form-group{{ $errors->has('attribute3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="attribute3" type="text" class="form-control" name="attribute3" value="{{ old('attribute3') }}">
                        ...
                        <div class="form-group{{ $errors->has('attribute4') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="attribute4" type="text" class="form-control" name="attribute4" value="{{ old('attribute4') }}">
                        ...
                        <div class="form-group{{ $errors->has('attribute5') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="attribute5" type="text" class="form-control" name="attribute5" value="{{ old('attribute5') }}">
                        ...
                        <div class="form-group{{ $errors->has('detail1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="detail1" type="text" class="form-control" name="detail1" value="{{ old('detail1') }}">
                        ...
                        <div class="form-group{{ $errors->has('detail2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="detail2" type="text" class="form-control" name="detail2" value="{{ old('detail2') }}">
                        ...
                        <div class="form-group{{ $errors->has('detail3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="detail3" type="text" class="form-control" name="detail3" value="{{ old('detail3') }}">
